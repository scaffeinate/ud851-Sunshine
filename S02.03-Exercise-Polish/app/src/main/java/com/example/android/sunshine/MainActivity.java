...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorMessagTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMessagTextView = (TextView) findViewById(R.id.tv_error_message);
    ...
    private void showWeatherDataView() {
        ...
        mErrorMessagTextView.setVisibility(View.INVISIBLE);
    }
    ...
    private void showErrorMessage() {
        ...
        mErrorMessagTextView.setVisibility(View.VISIBLE);
    }
