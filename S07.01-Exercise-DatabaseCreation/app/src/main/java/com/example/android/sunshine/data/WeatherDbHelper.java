...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_WEATHER_TABLE_SQL = " CREATE TABLE " + WeatherEntry.TABLE_NAME + " ( " +
            WeatherEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
            WeatherEntry.COLUMN_WEATHER_ID + " VARCHAR NOT NULL, " +
            ...
            WeatherEntry.COLUMN_DATE + " DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP " +
            " ); ";
