...
//  COMPLETED (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            case CODE_WEATHER:
                resCursor = mDb.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, null, null, null, null, sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                String weatherDate = uri.getPathSegments().get(1);
                resCursor = mDb.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, WeatherContract.WeatherEntry.COLUMN_DATE + " >= ?",
                        new String[]{weatherDate}, null, null, sortOrder);
                break;
            default:
        ...
        if (resCursor == null) {
            throw new SQLiteException("Query for URI failed :" + uri);
        }
