...
//  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    ...
    private static final int ID_DETAIL_LOADER = 4251;
...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mHighTemperatureView = (TextView) findViewById(R.id.tv_weather_high_temp);
        mLowTemperatureView = (TextView) findViewById(R.id.tv_weather_low_temp);
...
//  COMPLETED (34) Override onLoaderReset, but don't do anything in it yet
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        CursorLoader cursorLoader = new CursorLoader(this, mUri, WEATHER_DETAIL_PROJECTION, null, null, null);
        return cursorLoader;
    }
