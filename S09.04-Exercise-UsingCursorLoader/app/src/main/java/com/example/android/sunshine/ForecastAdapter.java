...
//      COMPLETED (8) Display the summary that you created above
        ...
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, mCursor.getInt(MainActivity.INDEX_COLUMN_WEATHER_ID));
        String dateStr = SunshineDateUtils.getFriendlyDateString(mContext, mCursor.getLong(MainActivity.INDEX_COLUMN_DATE), false);

        String weatherSummary = dateStr + " - " + description + " - " + SunshineWeatherUtils.formatHighLows(mContext, maxTemp, minTemp);
